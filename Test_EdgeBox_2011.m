...
%     txt_name = [do_dir 'Challenge2_Test_Task1_GT\gt_' img_value '.txt'];
    txt_name = [do_dir 'train-textloc\gt_' img_value '.txt'];
...
%     [gtRes,dtRes]=bbGt('evalRes',double(bbs),double(bbs),.1,1);
